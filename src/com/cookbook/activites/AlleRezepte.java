...
public class AlleRezepte extends Activity {
	...
	//editText-Input-Change-Listener: Falls sich der Input ändert
	...
	//SpinnerListener: Aktualisiert ListView, falls Spinner geändert wird
	...
	private void aktuList(final String cat, String name) {
			//Wandelt den übergegebenen String in zwei Strings um 
